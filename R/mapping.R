...
#' stands located in Mount Rainier National Park, WA, USA. These stands are 
...
#'   measurement, in cm}
#'   \item{x_coord}{within-stand x coordinate of tree, in meters from origin}
#'   \item{y_coord}{within-stand y coordinate of tree, in meters from origin}
#' }
